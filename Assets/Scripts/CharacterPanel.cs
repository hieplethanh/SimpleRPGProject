...
public class CharacterPanel : MonoBehaviour {
    ...
    void UpdateLevel()
    {
        ...
        this.levelFill.fillAmount = (float)player.PlayerLevel.CurrentExperience == 0?0:(float)player.PlayerLevel.CurrentExperience / (float)player.PlayerLevel.RequiredExperience;
    }
